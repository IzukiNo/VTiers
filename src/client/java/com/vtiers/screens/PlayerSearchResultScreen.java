...
import com.vtiers.profile.GameMode;
...
public class PlayerSearchResultScreen extends Screen {
    ...
    public void init() {
        ...
        addDrawableChild(ButtonWidget.builder(Text.of("Update"), (buttonWidget) -> VTiersClient.showUpdatedPlayerProfile(playerProfile, true)).dimensions(5, height - 20 - 5, 68, 20).tooltip(Tooltip.of(Text.of("Reload the player profile"))).build());
